  ...
  render() {
    ...
    return(
      ...
      <Dropdown
        ...
        :
          <Steam href='/api/auth/steam' target='_self'><img style={{margin: '0 auto'}} alt='steam' src='https://steamcommunity-a.akamaihd.net/public/images/signinthroughsteam/sits_01.png' /></Steam> 
        }
      </Nav>
      </React.Fragment>
    )
